...
class EngagementBehaviorNode:
    ...
    def getCombinedAnomalies(self, channel_id):
        ...
        views_subs_transformed_anomalies = get_anomalies(settings, data, threshold, start_date, 'views_subs', channel_id, columns)
        ...
        views_videos_transformed_anomalies = get_anomalies(settings, data, threshold, start_date, 'views_videos', channel_id, columns)
        ...
        views_comments_transformed_anomalies = get_anomalies(settings, data, threshold, start_date, 'views_comments', channel_id, columns)
        ...
        subs_videos_transformed_anomalies = get_anomalies(settings, data, threshold, start_date, 'subs_videos', channel_id, columns)
        ...
        subs_comments_transformed_anomalies = get_anomalies(settings, data, threshold, start_date, 'subs_comments', channel_id, columns)
        ...
        videos_comments_transformed_anomalies = get_anomalies(settings, data, threshold, start_date, 'videos_comments', channel_id, columns)
